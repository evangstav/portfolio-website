...
export const conductorDataEl: ConductorData = {
  name: "[EL] Evangelos Stavropoulos",
  tagline: "[EL] Conductor",

  heroImage: "[EL] /images/hero.jpg",
...
This section can span multiple paragraphs to provide rich detail about the conductor's formative years and the path that led them to conducting.`,
      image: "[EL] /images/bio-education.jpg",
    },
    {
      title: "[EL] Career Highlights",
...
Highlight any recordings, premieres of new works, or particularly memorable performances that have shaped the conductor's career trajectory.`,
      image: "[EL] /images/bio-career.jpg",
    },
    {
      title: "[EL] Artistic Vision",
...
Keep this section updated with the latest news and upcoming highlights.`,
      image: "[EL] /images/bio-current.jpg",
    },
  ],
  ...
  pressQuotes: [
    {
      quote: "[EL] A conductor of remarkable sensitivity and precision...",
      source: "[EL] Classical Music Magazine",
      year: "[EL] 2024",
    },
    {
      quote: "[EL] Electrifying performances that captivate audiences...",
      source: "[EL] The Arts Review",
      year: "[EL] 2024",
    },
    {
      quote: "[EL] One of the most promising conductors of their generation...",
      source: "[EL] Symphony Weekly",
      year: "[EL] 2023",
    },
  ],

  contactEmail: "[EL] contact@example.com",
